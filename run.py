...
from dataloader import BidirectionalOneShotIterator, DataIterator
...
def main(args):
    ...
    if args.do_train:
        ...
        train_dataloader = DataLoader(TrainDataset(train_triples, nentity, nrelation,
                                                   train_count, train_true_head, train_true_tail,
                                                   entity_dict),
                                      batch_size=args.batch_size,
                                      shuffle=True, num_workers=max(1, args.cpu_num // 2))
